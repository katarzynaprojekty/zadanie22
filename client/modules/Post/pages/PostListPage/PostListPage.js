  ...
  render() {
    return (
      <div>
        ...
        <PostList handleDeletePost={this.handleDeletePost} handleEditPost={this.handleEditPost} posts={this.props.posts} handleVoteUpPost={this.handleVoteUpPost} handleVoteDownPost={this.handleVoteDownPost} />
      </div>
    );
  }
}
